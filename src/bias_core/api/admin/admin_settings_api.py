...
from bias_core.runtime_diagnostics import detect_database_label, detect_realtime_driver
...
def save_mail_settings(request, payload: dict = Body(...)):
    ...
    settings_data = save_setting_group("mail", get_mail_settings_defaults(), normalized_payload)
